...
namespace App.BookingOnline.Service.Service.Reports
{
    public class ExcelCommon
    {
        public static void SetExcelNumberFormat(ExcelRange range, bool hideZero = false)
        {
