...
export class TransactionSummaryReportService extends BaseGridService {
  ...
  _deleteUrl: string;
  _getReportDataUrl: string = AppConfig.apiEndpoint + AppConfig.urls.transactionSummaryReport.getReportData
  _exportExcelUrl: string = AppConfig.apiEndpoint + AppConfig.urls.transactionSummaryReport.exportExcel
