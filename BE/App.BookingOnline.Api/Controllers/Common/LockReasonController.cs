...
namespace App.BookingOnline.Api.Controllers
{
    ...
    public class LockReasonController : BaseGridController<LockReasonDTO, LockReasonPagingModel, ILockReasonService>
    {
        public LockReasonController(ILockReasonService service) : base(service)
        {
        }
    }
