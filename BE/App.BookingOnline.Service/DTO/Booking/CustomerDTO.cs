...
namespace App.BookingOnline.Service.DTO
{
    public class CustomerDTO : IEntityDTO
    {
        ...
        public List<MemberCardDTO> MemberCards { get; set; } = new List<MemberCardDTO>();
    }

    public class CustomerExtendDTO : CustomerDTO
    {
        public List<MemberCardExtendDTO> MemberCards { get; set; }
    }
