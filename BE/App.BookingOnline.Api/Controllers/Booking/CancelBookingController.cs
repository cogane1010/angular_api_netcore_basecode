...
{
    public class CancelBookingController : GridController<BookingDTO, BookingFilterModel, ICancelBookingService>
    {
        public CancelBookingController(ICancelBookingService service) : base(service)
        {
        }
