...
@Component({
  selector: 'app-promotion-seagolf-add',
  templateUrl: './promotion-seagolf-add.component.html',
  styleUrls: ['./promotion-seagolf-add.component.scss']
})

export class PromotionSeagolfAddComponent extends BaseComponent implements OnInit {
  ...
  promotionFormulaList = asEnumerable([{"code": "percent","title": "Phần trăm"},{"code": "price","title": "Giá tiền"}]).ToArray();
  ...
  back() {
    this._router.navigateByUrl('/booking/promotion-seagolf');
  }
  ...
  addOrEdit(promotion: M_Promotion) {
    ...
    promotion.promotion_Type = 'seagolf'
